...
namespace Api_Youtube.Model
{
    public class Video
    {
        ...
        [Column("privacy_level")] public string PrivacyLevel { get; set; } = "public";

        [Column("video_url")] public string VideoUrl { get; set; }

        [Column("related_video_ids")] public string RelatedVideoIds { get; set; }

        [Column("duration_in_seconds")] public int DurationInSeconds { get; set; }

        [Column("views_count")] public int ViewsCount { get; set; } = 0;

        [Column("video_type")] public string VideoType { get; set; }
